...
let sound = true;
let images = {
  nearby1: 'url(assets/images/1.png)',
  nearby2: 'url(assets/images/2.png)',
  nearby3: 'url(assets/images/3.png)',
  nearby4: 'url(assets/images/4.png)',
  nearby5: 'url(assets/images/5.png)',
  nearby6: 'url(assets/images/6.png)',
  nearby7: 'url(assets/images/7.png)',
  nearby8: 'url(assets/images/8.png)',
  nearby0: 'url(assets/images/dirt.png)',
  flag: 'url(assets/images/redstone.png)',
  unselected: 'url(assets/images/stone.png)',
  bomb: 'url(assets/images/creeper.png)',
  bombflag: 'url(assets/images/creeperflagged.png)',
  bombexplode: 'url(assets/images/creeperexplode.png)',
  break0: 'url(assets/images/stone0.png)',
  break1: 'url(assets/images/stone1.png)',
  break2: 'url(assets/images/stone2.png)',
  break3: 'url(assets/images/stone3.png)',
  break4: 'url(assets/images/stone4.png)',
  break5: 'url(assets/images/stone5.png)',
  break6: 'url(assets/images/stone6.png)',
  break7: 'url(assets/images/stone7.png)',
  break8: 'url(assets/images/stone8.png)',
  break9: 'url(assets/images/stone9.png)',
};

let sounds = {
  creepersound: 'assets/sounds/creeper.mp3',
  break1: 'assets/sounds/stone1.mp3',
  break2: 'assets/sounds/stone2.mp3',
  break3: 'assets/sounds/stone3.mp3',
  reveal: 'assets/sounds/stone4.mp3',
  flag: 'assets/sounds/wet_grass1.mp3',
};
...
function gameOver(x, y) {
  ...
  let countdowndelay = setTimeout(() => {
    ...
    let timer = setTimeout(() => {
      let i = setInterval(() => {
        if (opacity > 0.5) {
          gameoversplash.style.opacity = opacity - 0.05;
          opacity -= 0.01;
        }
      }, 100);
    }, 1000);
